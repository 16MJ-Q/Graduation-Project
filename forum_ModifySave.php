...
include("conn.php");
$fID=$_GET["fID"];
$result=mysql_query("SELECT * FROM forum WHERE fID='$fID'");
...
<body>
<div>
<form action="forum_MS.php?fID=<?php echo $fID;?>" method="POST">
版块名称<input type="text" name="title" value="<?php echo $row[1];?>"/><br/><br/>
板块介绍（不超过25个字）<br/><textarea id="text" name="info" style="width:500px;height:150px;"><?php echo $row[3];?></textarea><br/><br/>
