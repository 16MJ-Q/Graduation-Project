...
$result2=mysql_query("UPDATE video SET reader=reader+'1' WHERE vID=$ID");
$result3=mysql_query("SELECT * FROM video ORDER BY reader DESC LIMIT 6");
?>
<!DOCTYPE html>
<html>
<head>
...
<form action="vcollect.php?vID=<?php echo $ID;?>" method="POST">
...
<div class="rec">
<div class="mingreen2">热门视频</div>
<br/>
<?php
while($row2=mysql_fetch_array($result3)){
?>
&nbsp;&nbsp;&nbsp;&nbsp;<a href="vcontext.php?vID=<?php echo $row2[0];?>" class="aa"><?php echo $row2[1];?></a>
<br/><br/>
<?php
}
?>
